...
public class TimelineAdapter extends FirebaseRecyclerAdapter<TimelineEvent, TimelineAdapter.TimelineHolder> {
    ...
    public TimelineHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        switch (viewType) {
            case VIEW_TYPE_ODD:
                ...
                return new TimelineHolder(view, false);
            case VIEW_TYPE_EVEN:
    ...
    public class TimelineHolder extends RecyclerView.ViewHolder {
        ...
        FrameLayout mTimelineSeparatorFL;

        @BindView(R.id.timeline_separator_circle)
        View mTimelineSeparator1;

        @BindView(R.id.timeline_separator_circle_2)
        View mTimelineSeparator2;

        TimelineHolder(View itemView, boolean isLast) {
            super(itemView);
